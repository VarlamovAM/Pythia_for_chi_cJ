...
FILES_SRC =   pythia_chic2.cc smearE.cc smearP.cc resolutionPhoton.cc resolutionElectron.cc IsElectronDetectedInCTS.cc IsPhotonDetectedInPHOS.cc IsPhotonDetectedInEMCAL.cc IsTriggeredByPHOS.cc Init.cc Invariant_mass_spectr_creator.cc
